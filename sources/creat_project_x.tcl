# 设置工程名(将[]替换为工程名)
set project_name mux2_1
# 设置芯片型号(将[]替换为芯片型号)
set chip_type xczu19eg-ffvc1760-2-i
# 设定IP版本
set ip_verion 1.0
...
set_property tooltip {unit:bit} [ipgui::get_guiparamspec -name "width" -component [ipx::current_core] ]
set_property widget {textEdit} [ipgui::get_guiparamspec -name "mode" -component [ipx::current_core] ]
set_property tooltip {} [ipgui::get_guiparamspec -name "mode" -component [ipx::current_core] ]

set_property enablement_dependency {spirit:decode(id('MODELPARAM_VALUE.mode')) == 0} \
